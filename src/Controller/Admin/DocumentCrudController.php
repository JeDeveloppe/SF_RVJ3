...
class DocumentCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            DateTimeField::new('endOfQuoteValidation')->setLabel('Fin de validation du devis')->setDisabled(true)->onlyOnDetail()->setFormat('yyyy.MM.dd à HH:mm:ss'),
            DateTimeField::new('createdAt')->setLabel('Devis créé le')->setDisabled(true)->onlyOnDetail()->setFormat('yyyy.MM.dd à HH:mm:ss'),
            DateTimeField::new('timeOfSendingQuote')->setLabel('Devis relancé le')->setDisabled(true)->onlyOnDetail()->setFormat('yyyy.MM.dd à HH:mm:ss'),
