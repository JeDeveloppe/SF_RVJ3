 ...
 */
final class Version20231122132818 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item_group_boite (item_group_id INT NOT NULL, boite_id INT NOT NULL, INDEX IDX_C75C9EBE9259118C (item_group_id), INDEX IDX_C75C9EBE3C43472D (boite_id), PRIMARY KEY(item_group_id, boite_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
