 ...
 */
final class Version20230910174416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_D8698A764C3A3BB ON document');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_D8698A764C3A3BB ON document (payment_id)');
    }
}
