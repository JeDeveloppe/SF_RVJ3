 ...
 */
final class Version20240319200707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ambassador (id INT AUTO_INCREMENT NOT NULL, city_id INT DEFAULT NULL, privatecity_id INT NOT NULL, organization VARCHAR(255) DEFAULT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, street VARCHAR(255) DEFAULT NULL, phone VARCHAR(18) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, fullurl VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, privatefirstname VARCHAR(255) NOT NULL, privatelastname VARCHAR(255) NOT NULL, privatestreet VARCHAR(255) NOT NULL, privatephone VARCHAR(18) NOT NULL, privateemail VARCHAR(255) NOT NULL, INDEX IDX_6C62F0CE8BAC62AF (city_id), INDEX IDX_6C62F0CE5FB123FD (privatecity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE document ADD CONSTRAINT FK_D8698A765F7D6850 FOREIGN KEY (shipping_method_id) REFERENCES shipping_method (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document DROP FOREIGN KEY FK_D8698A765F7D6850');
