 ...
 */
final class Version20240522161612 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE manual_invoice (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, address_id INT NOT NULL, reserve_id INT NOT NULL, INDEX IDX_7292F067A76ED395 (user_id), INDEX IDX_7292F0675913AEBF (reserve_id), INDEX IDX_7292F067F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
