 ...
 */
final class Version20231126164431 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE boite_item_group (boite_id INT NOT NULL, item_group_id INT NOT NULL, INDEX IDX_E370062D9259118C (item_group_id), INDEX IDX_E370062D3C43472D (boite_id), PRIMARY KEY(boite_id, item_group_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
